...
function findFolderByName(folderName) {
  ...
  for (const [filePath, module] of Object.entries(allIndexes)) {
    // Extract folder structure: "/src/content/psychology/dsm-5/index.jsx" -> "psychology/dsm-5"
...
function getPostsFromFolder(folderPath) {
  ...
  return allPosts.filter(post => {
    ...
    const allPostFiles = { ...allMdFiles, ...jsxPostFiles }
...
// Check for .md and .jsx files in any folder with matching name
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) => {
          ...
          if (!folderInfo || !folderInfo.module.order) {
